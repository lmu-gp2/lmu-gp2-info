...
Schließlich können wir unsere Analysen durchführen.
Zum Beispiel können wir mit einem t-Test oder einer ANOVA nach Gruppenunterschieden suchen, oder wir können die Daten mit `ggplot()` visualisieren.
